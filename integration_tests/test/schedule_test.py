...
class TestSchedule(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        print("Running TestSchedule")
        cls._client = WindmillClient()
        if not os.environ.get("WMILL_CONTINUITY_TEST", False):
    ...
    def tearDownClass(cls) -> None:
        if os.environ.get("WMILL_CONTINUITY_TEST", False):
    ...
    def test_script_schedule_running(self):
        ...
        latest_run_time = datetime.datetime.fromisoformat(latest_run["created_at"])
